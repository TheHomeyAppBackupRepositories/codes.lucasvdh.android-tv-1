...
class PairingManager extends events_1.EventEmitter {
    ...
    constructor(host, port, certs, service_name, manufacturer = 'unknown', model = 'unknown') {
        super();
        this.host = host;
        this.port = port;
        ...
        this.pairingMessageManager = new PairingMessageManager_1.default(manufacturer, model);
    }
    sendCode(code) {
