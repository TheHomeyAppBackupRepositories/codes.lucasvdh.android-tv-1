...
class RemoteManager extends events_1.default {
    ...
    constructor(host, port, certs, timeout = 1000, manufacturer = 'unknown', model = 'unknown') {
        super();
        this.host = host;
        this.port = port;
        this.certs = certs;
        ...
        this.remoteMessageManager = new RemoteMessageManager_1.default(manufacturer, model);
    }
    async start() {
                ...
                try {
                    ...
                    if (this.chunks.length > 0 && this.chunks.readInt8(0) === this.chunks.length - 1) {
                        ...
                        if (message.remoteConfigure) {
                            this.client?.write(this.remoteMessageManager.createRemoteConfigure(622, 'Build.MODEL', 'Build.MANUFACTURER', 1, 'Build.VERSION.RELEASE'));
                            this.emit('ready');
                        }
