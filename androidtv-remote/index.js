...
exports.RemoteDirection = exports.RemoteKeyCode = exports.AndroidRemote = void 0;
...
class AndroidRemote extends events_1.default {
    ...
    async start() {
        if (!this.cert.key || !this.cert.cert) {
            ...
            this.pairingManager = new PairingManager_1.PairingManager(this.host, this.pairing_port, this.cert, this.service_name, this.manufacturer, this.model);
        ...
        this.remoteManager = new RemoteManager_1.RemoteManager(this.host, this.remote_port, this.cert, this.timeout, this.manufacturer, this.model);
